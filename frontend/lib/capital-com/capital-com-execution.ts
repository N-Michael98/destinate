...
const MIN_SIZE: Record<string, number> = {
  ...
  // Commodities
  GOLD: 0.1, SILVER: 0.1, OIL_CRUDE: 0.1, OIL_BRENT: 0.1, NATURALGAS: 0.1,
  // Indices
  US100: 0.1, US500: 0.1, US30: 0.1, DE40: 0.1, UK100: 0.1, J225: 0.1,
...
const PIP_VALUE_PER_UNIT: Record<string, number> = {
  ...
  // Commodities
  GOLD: 1, SILVER: 0.5, OIL_CRUDE: 1, OIL_BRENT: 1, NATURALGAS: 0.1,
  // Indices
  US100: 1, US500: 1, US30: 1, DE40: 1, UK100: 1, J225: 1,
  // Crypto — Epics am 03.08. korrigiert (siehe EPIC_MAP), Werte unverändert
...
const DEFAULT_STOP_BY_STYLE: Record<string, Record<string, number>> = {
  SCALPING: {
    ...
    GOLD: 5, SILVER: 0.20, OIL_CRUDE: 0.30, OIL_BRENT: 0.30, NATURALGAS: 0.10,
    US100: 20, US500: 15, US30: 50, DE40: 20, UK100: 15, J225: 30,
  ...
  DAYTRADING: {
    ...
    GOLD: 15, SILVER: 0.50, OIL_CRUDE: 0.80, OIL_BRENT: 0.80, NATURALGAS: 0.25,
    US100: 50, US500: 35, US30: 120, DE40: 50, UK100: 35, J225: 80,
  ...
  SWING: {
    ...
    GOLD: 30, SILVER: 1.00, OIL_CRUDE: 1.50, OIL_BRENT: 1.50, NATURALGAS: 0.50,
    US100: 100, US500: 70, US30: 250, DE40: 100, UK100: 70, J225: 150,
...
const MAX_SIZE: Record<string, number> = {
  ...
  GOLD: 5, SILVER: 50, OIL_CRUDE: 10, OIL_BRENT: 10, NATURALGAS: 100,
  US100: 5, US500: 5, US30: 2, DE40: 5, UK100: 5, J225: 2,
