      ...
      <div className="flex">
        ...
        <section className="flex-1 p-10 max-w-[1700px] mx-auto" >
          ...
          <div className="flex items-start justify-between gap-8 mb-10">
            <div>
              <h2 className="text-5xl font-black">Willkommen Michael
          ...
          <section className="bg-gray-900 border border-gray-800 rounded-2xl p-7 mb-8">
            ...
            <p className="text-gray-400 mt-2">
              Die groen Architekturblcke sind jetzt als professionelle Center vorbereitet, statt alle Details im Dashboard zu zeigen.
            </p>
            ...
            <section className="bg-gray-900 border border-orange-900 rounded-2xl p-7 mb-8">
              <div className="flex items-start justify-between gap-6">
                <div>
                  ...
                  <p className="text-gray-400 mt-2">
                    Technische Roadmap- und Architektur-bersicht. Standardmig versteckt, damit das Dashboard professionell clean bleibt.
                  </p>
                </div>
